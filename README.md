...
Field Name | Type | Optional? | Description
---------- | ---- | --------- | -----------
```:client_log_timestamp``` | Number | Yes (will be filled in if not provided) | Time that an event was created.
---
### CohortMembership
...
```:position``` | Number | Yes | Content location in the list of insertions, calculated by Promoted and uses the Paging parameters. (*do not set*)
---
### Paging
#### TODO
---
